...
namespace MIM_Tool.Funktions
{
    internal class Funktion2DatenLesen
    {
        ...
        public void DatenLesenAbfrage()
        {
            ...
            {
                Log.err("Es sind noch nicht alle Monitore aktiviert oder die Icons sind noch nicht Zurück! \nFalls du Trotzdem die Daten Neu Laden willst, gehe in die Einstellung.", null ,true);//ex,alarm            // Zeigt eine Fehlermeldung an, wenn nicht alle Monitore aktiviert sind oder die Icons noch nicht verstaut sind
            }
            else
            {
